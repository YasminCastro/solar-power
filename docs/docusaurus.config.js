...
const config = {
  ...
  organizationName: "ifg", // Usually your GitHub org/user name.
  projectName: "solar-power", // Usually your repo name.
  ...
  themeConfig:
    ...
    ({
      ...
      footer: {
        ...
        copyright: `Copyright © ${new Date().getFullYear()} Solar Power, Inc. Built with Docusaurus.`,
      },
      prism: {
