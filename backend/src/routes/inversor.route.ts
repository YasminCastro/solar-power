...
import { CreateInversorDto, ElginDataDto, HauweiDataDto } from '@/dtos/inversor.dto';
...
export class InversorRoute implements Routes {
  ...
  private initializeRoutes() {
    this.router.post(`${this.path}`, AuthMiddleware, ValidationMiddleware(CreateInversorDto), this.inversor.getHauweiData);
